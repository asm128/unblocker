...
#pragma pack(pop)
	...
	struct SUsers			{
		...
		::gpk::array_obj<::ubk::SUserStatus>				Status		= {};
	...
	struct SHits			{
		::gpk::array_obj<::gpk::array_pod<::ubk::SHit>>		Phones		= {};
		::gpk::array_obj<::gpk::array_pod<::ubk::SHit>>		Addresses	= {};
		::gpk::array_obj<::gpk::array_pod<::ubk::SHit>>		Images		= {};
		::gpk::array_obj<::gpk::array_pod<::ubk::SHit>>		Websites	= {};
		::gpk::array_obj<::gpk::array_pod<::ubk::SHit>>		Mails		= {};
		::gpk::array_obj<::gpk::array_pod<::ubk::SHit>>		Hours		= {};
	};
} // namespace
